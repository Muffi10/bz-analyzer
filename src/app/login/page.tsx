...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      {/* Mobile Header */}
      <nav className="lg:hidden bg-white shadow-sm border-b border-gray-200 px-6 py-4">
      ...
      {/* Main Content */}
      <div className="flex-1 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 flex items-center justify-center p-4">
